...
define ("SQL_SALIDAS_USUARIO","FUNGIBLE_SALIDAS.COD,USUARIO,CENTRO,QUIEN,FECHA,MATERIAL,CANTIDAD,"
        . "RESIDENCIA,OBSERVACIONES,MATERIAL_FUNG.DESCRIPCION AS NOMBRE_MATERIAL, FUNG_QUIEN.PERSONA AS NOMBRE_QUIEN FROM " . TBL_SALIDAS . ","  . TBL_MATERIAL . 
       "," . TBL_QUIEN . " WHERE MATERIAL_FUNG.ID=FUNGIBLE_SALIDAS.MATERIAL AND USUARIO=:usuario AND "
        . " FUNGIBLE_SALIDAS.QUIEN=FUNG_QUIEN.COD ORDER BY FUNGIBLE_SALIDAS.COD DESC" );

define("SQL_BUSCA_SALIDAS_USUARIO","SELECT " . SQL_SALIDAS_USUARIO);
        
       

define("SQL_ULTIMA_SALIDA_USUARIO", "SELECT TOP 1 " . SQL_SALIDAS_USUARIO);
